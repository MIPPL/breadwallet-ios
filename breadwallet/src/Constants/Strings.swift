...
enum S {
    ...
    enum Send {
        ...
        static let legacyAddressWarning = NSLocalizedString("Send.legacyAddressWarning", value: "Warning: this is a legacy bitradio address. Are you sure you want to send Bitradio Cash to it?", comment: "Attempting to send to ")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value:"Unlock your Bitradio.", comment: "TouchID/FaceID prompt text")
    ...
    enum Transaction {
        ...
        static let tokenTransfer = NSLocalizedString("Transaction.tokenTransfer", value:"Fee for token transfer: %1$@", comment: "Fee for token transfer: Bitradio")
    }
    ...
    enum Settings {
        ...
        static let currencyPageTitle = NSLocalizedString("Settings.currencyPageTitle", value: "%1$@ Settings", comment: "Bitradio Settings page title")
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying Bitradio?", comment: "Are you enjoying Bitradio alert message body")
    ...
    enum About {
        ...
        static let walletID = NSLocalizedString("About.walletID", value:"Bitradio Rewards ID", comment: "About screen wallet ID label")
        static let footer = NSLocalizedString("About.footer", value:"Made by the global BRD team. Version %1$@", comment: "About screen footer")
        static let footer2 = NSLocalizedString("About.footer2", value:"Adapted to Bitradio by MIP", comment: "About screen footer 2")
    }
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the network but not in your Bitradio.", comment: "Syncing explanation")
    ...
    enum MenuButton {
        ...
        static let website = NSLocalizedString("MenuButton.website", value:"Website", comment: "Menu button title")
        static let lock = NSLocalizedString("MenuButton.lock", value:"Lock Wallet", comment: "Menu button title")
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy Bitradio", comment: "Buy bitradio title")
    ...
    enum StartViewController {
        ...
        static let message = NSLocalizedString("StartViewController.message", value: "The easy and secure way to use Bitradio coin.", comment: "Start view message")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "Bitradio has upgraded to using a 6-digit PIN. Tap Continue to upgrade.", comment: "Upgrade PIN prompt body.")
        }
    ...
    enum PaymentProtocol {
        enum Errors {
            ...
            static let smallTransaction = NSLocalizedString("PaymentProtocol.Errors.smallTransaction", value: "Bitradio transaction outputs can't be less than %1$@.", comment: "Output too small error message.")
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your Bitradio Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your Bitradio wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your bitradio wallet", comment: "<sitename> is requesting authentication using your bitradio wallet")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "Bitradio now supports Ethereum!", comment: "Welcome view title")
