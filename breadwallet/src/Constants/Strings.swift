...
enum S {
    ...
    enum Scanner {
        static let flashButtonLabel = NSLocalizedString("Scanner.flashButtonLabel", value:"Camera Flash", comment: "Scan Digiwage address camera flash toggle")
    }
    ...
    enum Send {
        ...
        static let legacyAddressWarning = NSLocalizedString("Send.legacyAddressWarning", value: "Warning: this is a legacy Digiwage address. Are you sure you want to send Bitcoin Cash to it?", comment: "Attempting to send to ")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Digiwage's keychain data and steal your Digiwage! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = NSLocalizedString("JailbreakWarnings.messageWithoutBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Digiwage's keychain data and steal your Digiwage. Please only use Digiwage on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let paperKeyDescription = NSLocalizedString("SecurityCenter.paperKeyDescription", value:"The only way to access your Digiwage if you lose or upgrade your phone.", comment: "Paper Key button description")
    ...
    enum UpdatePin {
        ...
        static let caption = NSLocalizedString("UpdatePin.caption", value:"Remember this PIN. If you forget it, you won't be able to access your Digiwage.", comment: "Update PIN caption text")
    ...
    enum RequestAnAmount {
        static let title = NSLocalizedString("RequestAnAmount.title", value:"Request an Amount", comment: "Request a specific amount of Digiwage")
    ...
    enum MenuButton {
        ...
        static let buy = NSLocalizedString("MenuButton.buy", value:"Buy Bitcoin", comment: "Buy Digiwage title")
    ...
    enum StartViewController {
        ...
        static let message = NSLocalizedString("StartViewController.message", value: "The easy and secure way to use Digiwage.", comment: "Start view message")
    }
    ...
    enum Import {
        ...
        static let confirm = NSLocalizedString("Import.confirm", value: "Send %1$@ from this private key into your wallet? The Digiwage network will receive a fee of %2$@.", comment: "Sweep private key confirmation message")
    ...
    enum BitID {
        ...
        static let authenticationRequest = NSLocalizedString("BitID.authenticationRequest", value: "%1$@ is requesting authentication using your Digiwage wallet", comment: "<sitename> is requesting authentication using your Digiwage wallet")
