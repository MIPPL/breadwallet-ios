...
class HomeTitheCell : UITableViewCell {
    
    static let cellIdentifier = "HomeTitheCell"
    ...
    func set( viewModel: HomeTitheViewModel ) {
    ...
    private func addConstraints() {
        ...
        check.constrain([
            ...
            check.topAnchor.constraint(equalTo: container.topAnchor, constant: C.padding[2])
        ])
