//
//  HomeBetDiceCell.swift
//  breadwallet
//
//  Created by MIP on 19/11/2020.
//  Copyright © 2020 Wagerr Ltd. All rights reserved.
//

import UIKit

class HomeBetDiceCell : UITableViewCell {
    
    static let cellIdentifier = "BetDiceCell"
    ...
    func set( viewModel: HomeDiceViewModel ) {
    ...
    private func addSubviews() {
        ...
        let checkImage = #imageLiteral(resourceName: "BetDice").withRenderingMode(.alwaysTemplate)
